...
CONTAINER_NAME="mindnote-fe-staging"
IMAGE_NAME="mindnote-fe:staging"
HOST_PORT="3010"
API_URL="http://195.110.58.111:8010/api/v1"
# ─────────────────────────────────────────────────────────────────────────────
...
echo ""
echo "✅ Staging is live → http://\${SERVER_IP}:\${HOST_PORT}"
